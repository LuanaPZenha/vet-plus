"""Cliente HTTP compartilhado para integração com o microsserviço de Animais."""
...
def animals_service_url() -> str:
    return os.environ.get("ANIMALS_SERVICE_URL", "http://127.0.0.1:8003").rstrip("/")
...
class HttpAnimalService(IAnimalService):
    ...
    def __init__(
        ...
        self._base_url = (base_url or animals_service_url()).rstrip("/")
